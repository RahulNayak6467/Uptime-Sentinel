...
export const getLastLimitChecks = async (req:Request, res:Response, next:NextFunction) => {
    ...
    try {
        ...
        const getLastLimitChecksData = await getLastChecksData(monitor_id,user_id,LIMIT_CHECKS);
