  ...
  return (
    <header className="flex items-center justify-between px-6 py-3 border-b border-sf-border bg-sf-surface">
      ...
      <div className="flex items-center gap-2">
        ...
        <button className="flex items-center gap-1.5 px-4 py-1.5 text-[13px] font-semibold text-sf-btn-text bg-sf-text rounded-lg hover:bg-sf-btn-hover active:bg-sf-btn-active transition-colors cursor-pointer">
