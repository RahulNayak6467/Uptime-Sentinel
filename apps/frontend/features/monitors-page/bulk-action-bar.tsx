    ...
    <div className="mb-1 flex items-center justify-between gap-4 rounded-lg border border-sf-border bg-sf-surface px-4 py-2.5 shadow-sm">
      <div className="flex items-center gap-3">
        ...
        <div className="flex items-center gap-1.5">
          ...
          <button className="flex cursor-pointer items-center gap-1.5 rounded-[4px] px-2.5 py-1.5 text-xs font-medium text-sf-text-sub transition-colors hover:bg-sf-green-bg hover:text-sf-green">
            <Play className="size-3.5" />
            Resume
          </button>
          <button className="flex cursor-pointer items-center gap-1.5 rounded-[4px] px-2.5 py-1.5 text-xs font-medium text-sf-text-sub transition-colors hover:bg-sf-red-bg hover:text-sf-red">
