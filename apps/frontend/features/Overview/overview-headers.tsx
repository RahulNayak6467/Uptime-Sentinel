const OverviewHeaders = () => {
  return (
    <header className="flex items-center justify-between px-6 py-3 border-b border-sf-border bg-sf-surface">
      <h1 className="text-[16px] font-bold text-sf-text font-sans">Overview</h1>

      <div className="flex items-center gap-2">
        <button className="px-4 py-1.5 text-[13px] font-semibold font-sans text-sf-text border border-sf-border rounded-lg hover:bg-sf-bg transition-colors cursor-pointer">
          Refresh
        </button>
