...
const Chip = ({ children }: { children: ReactNode }) => (
  <span className="inline-flex items-center gap-1 rounded-[4px] bg-sf-bg px-1.5 py-0.5 text-[10px] font-medium text-sf-text-sub ring-1 ring-inset ring-sf-border-faint">
    {children}
  </span>
);
